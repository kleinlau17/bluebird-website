...
title: Bluebird Theme Has Officially Been Released!
description: This is a sample blog post for Bluebird
publishDate: May 15, 2022
featuredImage: '/assets/images/blog/odyssey-theme-officially-released/featured.jpg'
excerpt: 'The time has come to officially release Bluebird Theme to the world. Learn more about what it is and how you can start using it today.'
tags: 
  - Bluebird Theme
---
...
To get started with the Bluebird Theme clone the [Bluebird Theme Repository](https://github.com/littlesticksdev/odyssey-theme) directly from GitHub or use one of the buttons below to quickly clone or deploy the theme's code.
